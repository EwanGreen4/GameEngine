...
bool GameApplication::mainLoop() {
  ...
  //  window =
  //      SDL_CreateWindow("Demo", SDL_WINDOWPOS_CENTERED,
  ...
  log(LOG_NONFATAL, std::to_string(rc.getSize("bmage.png")) + " bytes\n");
  log(LOG_NONFATAL, std::to_string(rc.getSize("image.png")) + " bytes\n");
